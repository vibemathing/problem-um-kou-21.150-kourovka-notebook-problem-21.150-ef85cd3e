...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-kou-21.150-kourovka-notebook-problem-21.150-ef85cd3e",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.150-8345ca42e36b",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.150"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Let $G$ be an extension of a normal elementary abelian subgroup $A$ by an elementary abelian group $B\\cong G/A$ such that $A$ contains an element $a$ with $C_B(a)=1$. Is it true that the rank of the subgroup $Z(\\langle a,B\\rangle)\\cap\\langle a,B\\rangle'$ is at most the rank of $B$?",
      "version": 1
    },
    "title": "Kourovka Notebook Problem 21.150",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "011d420993b9e35841da5a391a252891b547533a4de268efea75177d3dc73d0d"
}
```
